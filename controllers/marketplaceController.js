    ...
    configController.configGetPrice()
        .then(price => {
            ...
            const create_payment_json = {
                ...
                "redirect_urls": {
                    "return_url": `${process.env.DEVURL}/marketplace/payment/success/?userId=${userId}&clvAmount=${clvAmount}&bonusClvAmount=${bonusClvAmount}&bonusCode=${bonusCode}&donationPercent1=${donationPercent1}&donationPercent2=${donationPercent2}&donationPercent3=${donationPercent3}&donationPercent4=${donationPercent4}&donationPercent5=${donationPercent5}&donationPercent6=${donationPercent6}&usdAmount=${usdAmount}`,
                    "cancel_url": `${process.env.DEVURL}/marketplace/payment/cancel`
                },
                "transactions": [{
                    "item_list": {
                        "items": [{
